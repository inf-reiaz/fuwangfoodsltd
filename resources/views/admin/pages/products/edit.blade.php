                  ...
                  <div class="box">
                    <div class="box-body ">
                        ...
                        <div class="form-group {{ $errors->has('cat_name') ? 'has-error' : '' }}">
                            ...
                            {!! Form::select('cat_name', ['bread' => 'Bread', 'biscuit_chanachur' => 'Biscuit & Chanachur','toast' => 'Toast','cake' => 'Cake','choclate' => 'Choclate','others_drinks' => 'Others & Drinks','noodles' => 'Noodles'], null, ['placeholder' => 'Pick a size...','class' => 'form-control']) !!}
