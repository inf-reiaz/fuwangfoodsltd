 ...
 <section class="about-area section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="main-title">
                        <h2  style="color: #000;padding-bottom: 3%;" class="text-uppercase">Nomination And Remuneration Committee</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <h4 class="text-center" style="padding-top:30px;padding-bottom: 30px;">Nomination & Remuneration Committee</h4>
